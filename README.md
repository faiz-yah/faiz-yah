...
2. NLP Agriculture Farming QA Chatbot → [here](https://github.com/faiz-yah/nlp-projects)
...
### [3] Not to forget ...
1. Code from scratch → [here](https://github.com/faiz-yah/code-from-scratch)
2. Medium articles → [here](https://github.com/faiz-yah/medium-articles)
3. Learning data science tools → [here](https://github.com/faiz-yah/learning-data-science-tools)



<!--
**faiz-yah/faiz-yah** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
